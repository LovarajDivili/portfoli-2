...
const Contact = ({ UserData }) => {
  ...
  function sendEmail(e) {
    ...
    emailjs
      .sendForm(Config.SERVICE_ID, Config.TEMPLATE_ID, e.target)
      .then((res) => {
        EmailPopup.style.transform = "translateX(0)";
        setTimeout(() => {
          EmailPopup.style.transform = "translateX(50rem)";
        }, 3000);
  ...
  return (
    <section id="contact" className="Contact-section-main">
      <div
        className={
          "email-popup" + (emailSuccess ? " email-success" : " email-failed")
        }
      >
        {emailSuccess
      ...
      <div className="Contact-section-items">
        <a href={social.gmail} target={"_blank"}>
          <div className="Contact-section-item">Gmail</div>
        </a>
        <a href={social.linkedin} target={"_blank"}>
          <div className="Contact-section-item">Linked In</div>
        </a>
        <a href={social.whatsapp} target={"_blank"}>
          <div className="Contact-section-item">What's App</div>
        </a>
      </div>
      ...
      <div className="Contact-section-form">
        <div className="Contact-section-form-content">
          ...
          <form onSubmit={sendEmail}>
            ...
            <div className="Contact-section-form-item">
              <button className="Contact-section-form-button" type="submit">
                Send
              </button>
            </div>
          </form>
