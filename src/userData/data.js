...
const UserData = {
    ...
    expireance: [
        {
            ...
            link: 'www.virtualmaze.com',
        },
        {
            name: 'The Turbotechonologiese Soft Pvt Ltd',
            logo: CompanyLogo,
            start: 'JAN, 2019',
            end: 'FEB, 2020',
            description: 'I’ve stareted my career as a Jr Software developer. I’ve done more intresting projects and also devloped ERP based products for clients. It’s very challenging to maintain both college and work parallelly.',
            link: 'www.theturbotechnologies.com',
        },
    ],
    packages: [
    ...
    projects: [
        ...
        {
            image: GPS,
            company: 'The Turbotechonologiese Soft Pvt Ltd',
            name: 'Virtual Shop',
